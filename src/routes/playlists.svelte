...
<!-- <svg id="playarrow" xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-play-fill" viewBox="0 0 16 16">
...
<!-- <svg id="add" xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-plus" viewBox="0 0 16 16">
...
<svg id="pause" xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-pause" viewBox="0 0 16 16">
...
<div class="playlistBtnMain">
    <div class="playlistBtnGroup">
        ...
        <!-- <button class="playlistBtn">Select</button>
        <button class="playlistBtn">Load</button>
        <button class="playlistBtn">Edit</button>
        <button class="playlistBtn">Delete</button> -->
    </div>
</div>
